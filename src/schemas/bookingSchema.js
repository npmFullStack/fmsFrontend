...
export const bookingSchema = z.object({
  ...
  contact_number: z.string().optional(), // Changed to optional
  ...
  shipper_contact: z.string().optional(), // Changed to optional
  ...
  consignee_contact: z.string().optional(), // Changed to optional
  
  // Shipping preferences
  mode_of_service: z.string().min(1, "Mode of service is required"),
  container_size: z.union([z.string(), z.number()]).min(1, "Container size is required"), // Accepts both string and number
